  ...
  return (
    <Layout>
      <div className="bg-white dark:bg-gray-800 shadow overflow-hidden sm:rounded-lg p-6 transition-colors">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4 font-marathi">पद ४</h1>
        <p className="text-gray-600 dark:text-gray-300 font-marathi">
          This is a placeholder for पद ४. The content will be added later in Marathi.
        </p>
